...
export const adminManager = {
  ...
  getAdminMode: () => getAdminManager().isAdminModeActive(),
  isAdminModeActive: () => getAdminManager().isAdminModeActive(),
  setAdminUser: (admin: any) => getAdminManager().setAdminUser(admin),
  getAdminUser: () => getAdminManager().getAdminUser(),
  getMockAdminUser: () => getAdminManager().getMockAdmin(),
  ...
  setFeatureFlag: (flag: any, enabled: boolean) => getAdminManager().setFeature(flag, enabled),
  toggleFeature: (flag: any) => getAdminManager().toggleFeature(flag),
  getFeatureFlag: (flag: any) => getAdminManager().isFeatureEnabled(flag),
  isFeatureEnabled: (flag: any) => getAdminManager().isFeatureEnabled(flag),
  getAllFlags: () => getAdminManager().getAllFlags(),
  getAllFeatureFlags: () => getAdminManager().getAllFlags(),
  startTestSession: () => getAdminManager().startTestSession(),
  endTestSession: (sessionId: string) => getAdminManager().endTestSession(sessionId),
  logTestResult: (sessionId: string, passed: boolean) => getAdminManager().logTestResult(sessionId, passed),
};
